...
<head>
    ...
    <title>Delete Users | Typhoon Logistics</title>
    ...
    <style>
        ...
        .user-icon {
            ...
            margin-right: 10px;
            animation: userIconGlow 3s infinite alternate;
        }
...
<body>
    ...
    <div class="container animate__animated animate__fadeIn">
        ...
        <h1 class="mb-4 animate__animated animate__fadeInDown">USER MANAGEMENT</h1>
                    ...
                    if (mysqli_num_rows($run) < 1) {
                        ...
                        while ($data = mysqli_fetch_assoc($run)) {
                            ...
                            <tr class="animate__animated animate__fadeIn" style="animation-delay: calc(<?php echo $count; ?> * 0.1s)">
                                ...
                                <td><i class="fas fa-user user-icon"></i><?php echo $data['name']; ?></td>
                                <td><?php echo $data['email']; ?></td>
                                <td>
                                    <a href="usersdeleted.php?emm=<?php echo $data['email']; ?>" class="btn btn-danger btn-sm">

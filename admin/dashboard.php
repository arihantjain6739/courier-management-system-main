...
<head>
    ...
    <title>Admin Dashboard | Typhoon Logistics</title>
    ...
    <style>
        ...
        .navbar {
            ...
            box-shadow: 0 0 20px rgba(255, 44, 223, 0.2);
            position: relative;
            z-index: 10;
        }
        ...
        @keyframes optionPulse {
            0% { 
                box-shadow: 0 0 5px rgba(0, 249, 255, 0.3);
            }
            100% { 
...
<body>
    ...
    <div class="navbar animate__animated animate__fadeIn">
        <a href="../index.php" class="animate__animated animate__fadeIn animate__delay-1s">
            <i class="fas fa-user"></i> Login As User
        </a>
        <a href="logout.php" class="animate__animated animate__fadeIn animate__delay-2s">
    ...
    <div class="container animate__animated animate__fadeIn animate__delay-3s">
        ...
        <div class="options">
            <a href="deletedata.php" class="animate__animated animate__fadeIn animate__delay-4s">
                <i class="fas fa-trash-alt"></i> Delete Data
            </a>
            <a href="deleteusers.php" class="animate__animated animate__fadeIn animate__delay-5s">
